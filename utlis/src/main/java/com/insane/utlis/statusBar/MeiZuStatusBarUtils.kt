...
object MeiZuStatusBarUtils {
     ...
     * @return
     */
    private fun isBlackColor(color: Int, level: Int): Boolean {
     ...
     * @return　灰度值
     */
    private fun toGrey(rgb: Int): Int {
     ...
     * @param color  颜色
     */
    private fun setStatusBarDarkIcon(window: Window, color: Int) {
        try {
